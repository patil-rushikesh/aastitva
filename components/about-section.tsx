            ...
            <div className="space-y-8">
              <div className="bg-white rounded-2xl p-6 shadow-lg border border-yellow-200">
                ...
                <p className="text-gray-600 leading-relaxed">
                  To empower communities through sustainable development programs, quality education, accessible
                  healthcare, and social welfare initiatives that create lasting positive impact.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg border border-yellow-200">
                ...
                <p className="text-gray-600 leading-relaxed">
                  A world where every individual has equal opportunities to thrive, where communities are
                  self-sufficient, and where hope transforms into tangible progress for all.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative overflow-hidden rounded-2xl shadow-2xl">
              ...
              <div className="absolute bottom-6 left-6 text-white">
                <h4 className="text-xl font-bold mb-2">Our Dedicated Team</h4>
